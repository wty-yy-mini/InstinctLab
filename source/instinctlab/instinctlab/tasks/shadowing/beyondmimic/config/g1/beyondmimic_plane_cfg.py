...
MOTION_NAME = "LAFAN1G1"
DEFAULT_LAFAN1_G1_PATH = "/home/user/Coding/robotics/humanoid_target_tracking/data/LAFAN1_g1"
...
class AmassMotionCfg(AmassMotionCfgBase):
    ...
    path = os.path.expanduser(os.environ.get("INSTINCT_BEYONDMIMIC_MOTION_PATH", DEFAULT_LAFAN1_G1_PATH))
    retargetting_func = None
    filtered_motion_selection_filepath = os.environ.get("INSTINCT_BEYONDMIMIC_MOTION_SELECTION")
